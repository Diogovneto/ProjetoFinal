...
class TabelaBDPacientes (val db: SQLiteDatabase) {
    ...
    fun cria() {
        db.execSQL("CREATE TABLE $NOME (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $CAMPO_NOME TEXT NOT NULL, $CAMPO_DATA_NASCIMENTO DATE NOT NULL, $CAMPO_SEXO TEXT NOT NULL, $CAMPO_MORADA TEXT NOT NULL, $CAMPO_CODIGO_POSTAL INTEGER NOT NULL, $CAMPO_TELEMOVEL INTEGER NOT NULL, $CAMPO_EMAIL TEXT NOT NULL, $CAMPO_CARTAO_CIDADAO INTEGER NOT NULL, $CAMPO_CONTRIBUINTE INTEGER NOT NULL)")
    }
