...
class Consulta(
    ...
    companion object {
        fun fromCursor(cursor: Cursor): Consulta {
            ...
            val posGeneroMedico = cursor.getColumnIndex(TabelaBDMedicos.CAMPO_GENERO)
            ...
            val genero_medico = cursor.getString(posGeneroMedico)
            ...
            val posGeneroPaciente = cursor.getColumnIndex(TabelaBDPacientes.CAMPO_GENERO)
            ...
            val genero_paciente = cursor.getString(posGeneroPaciente)
            ...
            val medico = Medico(nome_medico, telemovel_medico, email_medico, genero_medico, cartao_cidadao_medico, especialidade_medico, id_medico)
            val paciente = Paciente(nome_paciente, data_nascimento_paciente, genero_paciente, morada, codigo_postal, telemovel_paciente, email_paciente, cartao_cidadao_paciente, contribuinte, id_paciente)
